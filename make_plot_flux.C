...
void make_plot_flux()
{
    ...
    auto gre = new TGraph("./dat_files/spectrum_DUNE_e.dat");
    auto grmu = new TGraph("./dat_files/spectrum_DUNE_mu.dat");
    auto grtau = new TGraph("./dat_files/spectrum_DUNE_tau.dat");
