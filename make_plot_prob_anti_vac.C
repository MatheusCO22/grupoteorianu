...
void make_plot_prob_anti_vac()
{
    ...
    auto gr_antimu = new TGraph("./dat_files/probability_DUNE_antimu_vac.dat");
    auto gr_antie = new TGraph("./dat_files/probability_DUNE_antie_vac.dat");
    auto gr_antitau = new TGraph("./dat_files/probability_DUNE_antitau_vac.dat");
