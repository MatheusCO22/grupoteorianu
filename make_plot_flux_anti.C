...
void make_plot_flux_anti()
{
    ...
    auto gr_antie = new TGraph("./dat_files/spectrum_DUNE_antie.dat");
    auto gr_antimu = new TGraph("./dat_files/spectrum_DUNE_antimu.dat");
    auto gr_antitau = new TGraph("./dat_files/spectrum_DUNE_antitau.dat");
