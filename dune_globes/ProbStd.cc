...
int main(int argc, char * argv[])
{
	...
	outstdmu_vac.open("../dat_files/probability_DUNE_mu_vac.dat");
	outstde_vac.open("../dat_files/probability_DUNE_e_vac.dat");
	outstdtau_vac.open("../dat_files/probability_DUNE_tau_vac.dat");

	outstde_mat.open("../dat_files/probability_DUNE_e_mat.dat");
	outstdmu_mat.open("../dat_files/probability_DUNE_mu_mat.dat");
	outstdtau_mat.open("../dat_files/probability_DUNE_tau_mat.dat");

	//ANTI NEUTRINOS
	outstd_antimu_vac.open("../dat_files/probability_DUNE_antimu_vac.dat");
	outstd_antie_vac.open("../dat_files/probability_DUNE_antie_vac.dat");
	outstd_antitau_vac.open("../dat_files/probability_DUNE_antitau_vac.dat");

	outstd_antie_mat.open("../dat_files/probability_DUNE_antie_mat.dat");
	outstd_antimu_mat.open("../dat_files/probability_DUNE_antimu_mat.dat");
	outstd_antitau_mat.open("../dat_files/probability_DUNE_antitau_mat.dat");
