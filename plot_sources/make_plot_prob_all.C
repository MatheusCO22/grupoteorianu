...
void make_plot_prob_all()
{
    ...
    auto gre_mat = new TGraph((dat_dir+"probability_DUNE_e_mat.dat").c_str());
    auto grmu_mat = new TGraph((dat_dir+"probability_DUNE_mu_mat.dat").c_str());
    auto grtau_mat = new TGraph((dat_dir+"probability_DUNE_tau_mat.dat").c_str());

    auto gre_vac = new TGraph((dat_dir+"probability_DUNE_e_vac.dat").c_str());
    auto grmu_vac = new TGraph((dat_dir+"probability_DUNE_mu_vac.dat").c_str());
    auto grtau_vac = new TGraph((dat_dir+"probability_DUNE_tau_vac.dat").c_str());
