...
void make_plot_prob_mat()
{
    ...
    auto grmu = new TGraph("./dat_files/probability_DUNE_mu_mat.dat");
    auto gre = new TGraph("./dat_files/probability_DUNE_e_mat.dat");
    auto grtau = new TGraph("./dat_files/probability_DUNE_tau_mat.dat");
